...
- 692197df3: Installation of a git-hosted dependency should not fail if the `oyarn.lock` file of the installed dependency is not up-to-date [#6865](https://github.com/pnpm/pnpm/issues/6865).
